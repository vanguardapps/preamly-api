...
import addIdAndKind, { SchemaWithOptions } from "./utils/add-id-and-kind";
import addPluralKinds from "./utils/add-plural-kinds";
import { User, Role, Kind } from "../graphql/codegen-server/schema-types";
import {
  TokenType,
  TokenPayload,
  generateToken,
...
addIdAndKind(userSchema as SchemaWithOptions, Kind.User);
